...
- q: When is Agency Debt usually the better fit?
  a: Agency Debt tends to fit when cash-flow durability, pricing certainty, and
    long-term hold objectives align with that structure's underwriting strengths.
- q: When does Bridge Debt make more sense?
  a: Bridge Debt may fit transitional timelines, value-add scope, or flexibility
...
| Factor | Agency Debt | Bridge Debt |
|--------|-------------|-------------|
| Typical asset stage | Stabilized, durable NOI | Transitional, value-add, lease-up |
| Rate structure | Often fixed permanent | Often floating, shorter initial term |
| DSCR emphasis | In-place stabilized coverage | May accept lower in-place with credible business plan |
| Typical leverage | Often ~60–75% LTV on core assets | Often higher for transitional assets |
| Closing timeline | Often 60–90+ days | Often 30–45 days when diligence is organized |
| Exit / takeout | Prepay (YM, defeasance) on permanent hold | Extension options and refinance path are critical |
| Best fit | Long hold, cash-flow durability | Capex, repositioning, shorter hold periods |
