...
- q: How do sponsors choose an interest-rate cap strategy on floating-rate bridge loans?
  a: Most sponsors compare cap strikes against downside DSCR and monthly carry to balance upfront premium versus protection. With one-month SOFR near 3.6%-3.7% in July 2026, a lower strike (for example near 4.0%-5.0% on the index) costs more but can preserve debt service coverage if short-term rates stay elevated. The right structure is the one that keeps the business plan financeable through at least one adverse-rate scenario—cap pricing moves with index levels and should be re-quoted before closing.
