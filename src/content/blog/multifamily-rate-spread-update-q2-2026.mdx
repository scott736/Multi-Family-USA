...
- q: What spread range should operators expect across agency, bridge, and bank executions today?
  a: For stabilized US multifamily, agency executions often clear around benchmark plus 150-220 bps when sponsorship and property quality are strong. Bridge debt for transitional assets is usually wider, often benchmark plus 275-500 bps plus the cost of a rate cap. Regional and national bank pricing frequently sits between those ranges but can include recourse, cash sweep triggers, or tighter covenants. These ranges reflect recent quote cycles as of August 2026 and vary by lender—they are not guarantees.
...
{/* linker-force-bridge */}
Operators comparing options often continue with [How Operators Are Sizing Bridge Risk in 2026](/blog/how-operators-are-sizing-bridge-risk/) before booking a strategy call.

{/* linker-force-bridge */}
That decision sits inside our [Multifamily Underwriting Calculators](/tools/cap-rate-noi-calculator/) hub, where Multi-Family USA maps lender fit and structure tradeoffs.

{/* linker-force-bridge */}
That decision sits inside our [Compare Multifamily Capital Options](/compare/fixed-vs-floating-rate/) hub, where Multi-Family USA maps lender fit and structure tradeoffs.

{/* linker-force-bridge */}
That decision sits inside our [Investor Playbooks](/invest/value-add-sponsor/) hub, where Multi-Family USA maps lender fit and structure tradeoffs.

{/* linker-force-bridge */}
That decision sits inside our [Investor Playbooks](/invest/small-portfolio-operator/) hub, where Multi-Family USA maps lender fit and structure tradeoffs.

{/* linker-force-bridge */}
That decision sits inside our [Multifamily Financing Guides](/learn/rate-risk-and-refinance-planning/) hub, where Multi-Family USA maps lender fit and structure tradeoffs.
