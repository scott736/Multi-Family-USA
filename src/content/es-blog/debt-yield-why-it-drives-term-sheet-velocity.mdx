...
- q: What debt-yield range typically gets faster lender feedback on multifamily term sheets?
  a: For many US commercial multifamily executions, lenders tend to move faster when in-place debt yield starts in a strong range for the product type and risk profile. Higher debt yield gives committees confidence that cash flow can support the loan even if cap rates or rates move. Transactions below a lender's internal floor often get delayed, re-sized, or repriced.
...
> **Nota editorial:** Metadatos en español para esta artículo. El cuerpo se está localizando; la [versión en inglés](/blog/debt-yield-why-it-drives-term-sheet-velocity/) sigue siendo la referencia editorial más actualizada.
