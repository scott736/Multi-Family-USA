...
- q: How do sponsors choose an interest-rate cap strategy on floating-rate bridge loans?
  a: Most sponsors compare cap strikes against downside DSCR and monthly carry to balance upfront premium versus protection. A lower strike (for example near 3%-4% on the index) costs more but can preserve debt service coverage if short-term rates stay high. The right structure is the one that keeps the business plan financeable through at least one adverse-rate scenario.
...
> **Nota editorial:** Metadatos en español para esta artículo. El cuerpo se está localizando; la [versión en inglés](/blog/how-operators-are-sizing-bridge-risk/) sigue siendo la referencia editorial más actualizada.
