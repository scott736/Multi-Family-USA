...
| Factor | Deuda agency | Deuda bridge |
|--------|--------------|--------------|
| Etapa típica del activo | Estabilizado, NOI durable | Transicional, value-add, lease-up |
| Estructura de tasa | A menudo permanente fija | A menudo flotante, plazo inicial más corto |
| Énfasis en DSCR | Cobertura in-place estabilizada | Puede aceptar in-place más bajo con plan creíble |
| Apalancamiento típico | A menudo ~60–75% LTV en activos core | A menudo mayor en activos transicionales |
| Cronograma de cierre | A menudo 60–90+ días | A menudo 30–45 días con diligencia organizada |
| Salida / takeout | Prepago (YM, defeasance) en hold permanente | Opciones de extensión y ruta de refinanciamiento críticas |
| Mejor encaje | Hold largo, durabilidad de flujo de caja | Capex, reposicionamiento, holds más cortos |
