---
title: Deuda con recourse vs. Deuda sin recourse en multifamiliar
description: Marco de decisión que compara Deuda con recourse y Deuda sin recourse para ejecución de financiamiento multifamiliar en EE. UU. en activos de 5+ unidades.
productA: Deuda con recourse
productB: Deuda sin recourse
...
faq:
- q: ¿Deuda con recourse siempre es más barato que Deuda sin recourse?
...
- q: ¿Cuándo suele ser Deuda con recourse el mejor encaje?
  a: Deuda con recourse tiende a encajar cuando la durabilidad del flujo de caja,
    certeza de pricing y objetivos de hold a largo plazo se alinean con las
    fortalezas de suscripción de esa estructura.
- q: ¿Cuándo tiene más sentido Deuda sin recourse?
  a: Deuda sin recourse puede encajar en cronogramas transicionales, alcance
...
## Deuda con recourse vs. Deuda sin recourse: contexto de decisión

Comparar Deuda con recourse y Deuda sin recourse no es solo un ejercicio de pricing. En financiamiento multifamiliar, la mejor opción es la que mejor respalda el cronograma de su plan de negocio, resiliencia a la baja y flexibilidad de salida en activos de 5+ unidades.
...
| Factor | Deuda con recourse | Deuda sin recourse |
|--------|--------------------|--------------------|
| Responsabilidad del patrocinador | Garantía personal o de entidad más allá del activo | Limitada al activo y garantías estándar carve-out |
| Pricing típico | A menudo spread más bajo con respaldo de garantía | A menudo spread más amplio por eliminar garantía |
| Enfoque de suscripción | Liquidez, patrimonio y track record del patrocinador | Flujo de caja del activo, reservas y NOI a la baja |
| Apalancamiento típico | A menudo mayor con balance fuerte del patrocinador | A menudo menor o con más reservas |
| Fuentes comunes | Bancos, algunos prestamistas puente | Agency, CMBS, muchos debt funds |
| Carve-outs bad-boy | Recourse completo por fraude, desperdicio, bancarrota | Excepciones estándar de no-recourse siguen aplicando |
| Mejor encaje | Patrocinadores con liquidez fuerte buscando menor costo | Holds institucionales, JV, aislamiento de responsabilidad |
