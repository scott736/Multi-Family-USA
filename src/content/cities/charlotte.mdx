...
- q: What pricing context should sponsors cite for Charlotte deals?
  a: Median pricing near $171,000 per unit and typical cap rates around 5.3% are
    directional baselines—neighborhood-level comps still drive lender value
    opinions.
- q: What rent assumptions need local support in Charlotte?
  a: Median rent near $1,690 per unit can frame conversations, but lenders expect
