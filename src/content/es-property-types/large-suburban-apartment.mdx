...
description: Guía de suscripción y ejecución de deuda para activos Comunidades suburbanas de apartamentos grandes en financiamiento multifamiliar en EE. UU. (mínimo 5 unidades).
...
faq:
- q: ¿Cómo varía el apetito del prestamista para Comunidades suburbanas de apartamentos grandes?
...
- q: ¿Qué banda de cap rate es típica para Comunidades suburbanas de apartamentos grandes?
  a: Bandas direccionales de cap rate cerca de 4.8% - 6.2% varían por mercado,
