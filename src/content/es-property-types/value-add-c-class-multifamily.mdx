...
- q: ¿Qué banda de cap rate es típica para Value-Add C-Class Multifamily?
  a: Bandas direccionales cerca de 5.8% - 7.5% varían por mercado, condición y
...
> **Nota editorial:** Metadatos en español para esta tipo de propiedad. El cuerpo se está localizando; la [versión en inglés](/property-types/value-add-c-class-multifamily/) sigue siendo la referencia editorial más actualizada.
