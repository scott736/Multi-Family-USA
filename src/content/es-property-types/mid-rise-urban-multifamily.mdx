...
description: Guía de suscripción y ejecución de deuda para activos Multifamiliar urbano mid-rise en financiamiento multifamiliar en EE. UU. (mínimo 5 unidades).
...
faq:
- q: ¿Cómo varía el apetito del prestamista para Multifamiliar urbano mid-rise?
...
- q: ¿Qué banda de cap rate es típica para Multifamiliar urbano mid-rise?
  a: Bandas direccionales de cap rate cerca de 4.2% - 5.8% varían por mercado,
