...
- q: What legal and tax factors matter in Kentucky underwriting?
  a: Sponsors should address Kentucky's judicial foreclosure framework,
    property-tax context near 0.86%, the absence of statewide rent control, and
    state income tax implications early in diligence.
- q: How should sponsors use statewide cap-rate context in Kentucky?
