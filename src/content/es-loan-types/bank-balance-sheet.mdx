...
description: Marco de ejecución para préstamos multifamiliares en balance de banco en financiamiento comercial en EE. UU., incluyendo encaje, restricciones y controles de riesgo.
...
faq:
- q: ¿Quién debería considerar Préstamo multifamiliar en balance de banco?
...
- q: ¿Qué supuestos de periodo de hold encajan con Préstamo multifamiliar en balance de banco?
  a: Los patrocinadores suelen suscribir hacia un hold de 3-7 years, pero deben
