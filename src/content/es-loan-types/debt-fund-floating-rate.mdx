...
description: Marco de ejecución para préstamos a tasa flotante de debt fund en financiamiento multifamiliar comercial en EE. UU., incluyendo encaje, restricciones y controles de riesgo.
...
faq:
- q: ¿Quién debería considerar Préstamo a tasa flotante de debt fund?
...
- q: ¿Qué supuestos de periodo de hold encajan con Préstamo a tasa flotante de debt fund?
  a: Los patrocinadores suelen suscribir hacia un hold de 2-5 years, pero deben
