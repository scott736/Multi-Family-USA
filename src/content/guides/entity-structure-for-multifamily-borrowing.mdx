...
- q: When should sponsors finalize entity structure?
  a: Before formal lender submission when possible—late entity changes can delay
    legal review and closing timelines.
- q: How do guarantor frameworks affect term sheets?
  a: Recourse scope, liquidity requirements, and experience thresholds often move
    with entity type and sponsorship structure.
