---
title: Rate Risk and Refinance Planning
description: Rate risk and refinance planning framework for multifamily sponsors using
  agency, bridge, and CMBS executions.
h1: Rate Risk and Refinance Planning
category: risk
...
- q: How should sponsors plan for floating-rate exposure?
  a: Model index paths, cap expiration, extension triggers, and refinance timing
    under multiple rate scenarios—not a single forward curve.
- q: When should refinance planning start on bridge deals?
  a: At or before closing, with milestones tied to NOI stabilization and lender
    takeout criteria documented in the operating plan.
- q: What reserve logic helps manage rate risk?
  a: Liquidity buffers for debt service, capex, and extension fees can preserve
    optionality when rates or NOI move against the plan.
