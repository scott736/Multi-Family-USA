...
<KeyTakeaways
  points={[
    "Debt yield es un piso de riesgo del prestamista; el LTV depende de supuestos de valuación.",
    "Apalancamiento alto con debt yield débil aumenta riesgo de refinanciamiento y extensión.",
    "Use restricciones combinadas de debt yield, DSCR y LTV para definir proceeds reales.",
    "Escenarios de expansión de cap rate deben incluirse en todo modelo de refinanciamiento.",
    "La ejecución permanente mejora cuando la disciplina de apalancamiento se fija antes de pujar.",
  ]}
/>
