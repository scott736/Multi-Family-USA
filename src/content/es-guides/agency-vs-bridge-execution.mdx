...
description: "Cómo elegir entre deuda agency y bridge según estabilización, cronograma de capex y riesgo de refinanciamiento."
...
- q: ¿Cuándo conviene elegir deuda agency frente a bridge?
  a: Agency encaja con NOI estabilizado, flujo predecible y holds largos donde la
    certeza de precio importa más que la flexibilidad a corto plazo.
- q: ¿Qué señales indican que bridge es la mejor vía?
  a: Bridge suele encajar cuando un plan creíble de value-add o lease-up necesita
    desembolsos antes de que el flujo estabilizado soporte deuda permanente.
- q: ¿Cómo comparar el costo total entre vías?
  a: Modele comisiones, reservas, economía de extensiones y restricciones de
    prepago en todo el hold—no solo el cupón inicial.
...
> **Nota editorial:** Metadatos en español para esta guía. El cuerpo se está localizando; la [versión en inglés](/learn/agency-vs-bridge-execution/) sigue siendo la referencia editorial más actualizada.
...
<KeyTakeaways
  points={[
    "Agency debt fits stabilized or near-stabilized assets with durable cash flow.",
    "Bridge debt fits transitional plans but requires explicit extension and refinance contingencies.",
    "Execution choice should be driven by timeline risk and capex scope, not coupon alone.",
    "Model multiple rate paths and take-out assumptions before selecting floating debt.",
    "Sponsor reporting quality directly affects pricing and lender confidence during transitions.",
  ]}
/>
