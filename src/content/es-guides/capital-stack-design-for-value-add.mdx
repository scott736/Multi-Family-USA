...
<KeyTakeaways
  points={[
    "Las decisiones de capital stack deben partir de durabilidad de flujo de caja a la baja, no de proceeds máximos.",
    "Deuda senior, mezzanine y pref equity deben modelarse como estructura integrada.",
    "El ritmo de renovación y supuestos de lease-up impulsan costo de carry y riesgo de extensión.",
    "La disciplina de reporteo operativo mejora la confianza de prestamistas y socios de equity.",
    "Un stack conservador protege opcionalidad cuando los mercados reprician durante la ejecución.",
  ]}
/>
