...
description: "Marco práctico de suscripción multifamiliar en EE. UU. para adquisiciones y refinanciamientos comerciales de 5+ unidades."
...
- q: ¿Qué esperan los prestamistas en la primera presentación?
  a: Vistas claras de NOI in-place y estabilizado, rent roll, cronograma del plan
    de negocio y sensibilidad a la baja en métricas clave.
- q: ¿Cómo prepararse para preguntas del comité de crédito?
  a: Anticipe cuestionamientos sobre ocupación, concesiones, capex y
    refinanciamiento con respuestas documentadas.
- q: ¿Por qué importa el escenario a la baja antes de elegir prestamista?
  a: Deals que solo funcionan en caso base suelen renegociarse tarde; probar
    ocupación, gastos y tasas temprano mejora certeza de ejecución.
...
> **Nota editorial:** Metadatos en español para esta guía. El cuerpo se está localizando; la [versión en inglés](/learn/multifamily-underwriting-basics/) sigue siendo la referencia editorial más actualizada.


import KeyTakeaways from "@/components/dscr/KeyTakeaways.astro";

## What are multifamily underwriting basics for 5+ unit deals?

Multifamily underwriting basics start with a lender-grade NOI bridge, a clear business plan, and debt metrics tested together—DSCR, debt yield, and LTV—not in isolation. Sponsors who separate in-place from stabilized cash flow and document downside stress usually receive faster, more credible term sheet feedback.
